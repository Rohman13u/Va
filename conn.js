...
const isOwner = [`${setting.ownerNumber}`,"6285878105774@s.whatsapp.net","6285641292796@s.whatsapp.net"].includes(sender) ? true : false
...
const gurbot = '6285878105774@s.whatsapp.net'
...
var dev = '6285878105774@s.whatsapp.net'
